...
pub fn objects(query: picvudb::data::get::GetObjectsQuery) -> String
{
    match query
    {
        picvudb::data::get::GetObjectsQuery::ByModifiedDesc => "/view/objects/by_modified_desc",
        picvudb::data::get::GetObjectsQuery::ByAttachmentSizeDesc => "/view/objects/by_size_desc",
    }.to_owned()
}

pub fn objects_with_pagination(query: picvudb::data::get::GetObjectsQuery, page: u64, page_size: u64) -> String
{
    format!("{}?offset={}&page_size={}", objects(query), (page - 1) * page_size, page_size)
}
